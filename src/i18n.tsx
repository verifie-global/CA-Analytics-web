...
const messages = {
  ...
  "Text Connector PoC": { hy: "Տեքստային միակցիչի PoC", ru: "PoC текстового коннектора" },
  "Admin · Proof of concept": { hy: "Ադմին · Հայեցակարգի փորձարկում", ru: "Администратор · Проверка концепции" },
  "PoC replay tool": { hy: "PoC վերարտադրման գործիք", ru: "Инструмент повтора PoC" },
  ...
  "PoC validation checklist": { hy: "PoC ստուգման ցանկ", ru: "Контрольный список PoC" },
