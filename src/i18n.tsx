...
const messages = {
  ...
  "Collecting": { hy: "Հավաքագրվում է", ru: "Собирается" },
  ...
  "Text Connectors": { hy: "Տեքստային միացուցիչներ", ru: "Текстовые коннекторы" },
  "Admin · Connector settings": { hy: "Ադմին · Միացուցիչների կարգավորումներ", ru: "Администратор · Настройки коннекторов" },
  "Connector accounts": { hy: "Միացուցիչների հաշիվներ", ru: "Учетные записи коннекторов" },
  "Create account": { hy: "Ստեղծել հաշիվ", ru: "Создать учетную запись" },
  "Voice": { hy: "Ձայն", ru: "Голос" },
  "Text": { hy: "Տեքստ", ru: "Текст" },
  "Conversation detail": { hy: "Զրույցի մանրամասներ", ru: "Детали разговора" },
  "Finalize and analyze": { hy: "Ավարտել և վերլուծել", ru: "Завершить и проанализировать" },
  "Finalizing…": { hy: "Ավարտվում է…", ru: "Завершение…" },
  "No messages available yet.": { hy: "Հաղորդագրություններ դեռ չկան։", ru: "Сообщений пока нет." },
